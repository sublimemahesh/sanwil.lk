...
$ODISTRICT = new District($ORDER->district);
$OCITY = new City($ORDER->city);
?>
<!DOCTYPE HTML>
<html lang="en-US"> 
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">

        <title>Ceylon Fine Spices</title>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 order-details">
                                        <div class="card">
                                            ...
                                            <div class="body">
                                                ...
                                                <div  class="btn-back">
                                                    <a href="./" class="btn btn-green">Back</a>
