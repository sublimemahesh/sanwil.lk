...
if (!empty($_SESSION["shopping_cart"])) {
    ...
    foreach ($_SESSION["shopping_cart"] as $key => $value) {
        ...
        $output .= '<tr">'
                ...
                . '</a></td>'
                . '<td class="text-left cart-t"><a class="cart-n-width" href="product.php?id=' . $p_id . '">' . $name . '</a></td>'
                . '<td class="text-left cart-t"><div class="input-group cart-qty btn-block quantity">'
                ...
                . '</span>'
                . '</div></td>'
                . '<td class="text-right cart-t"><a class="cart-p1">Rs: ' . number_format($value["product_price"], 2) . '</a></td>'
                . '<td class="text-right cart-t"><a class="cart-p1">Rs: ' . number_format($value["product_quantity"] * $value["product_price"], 2) . '</a></td>'
