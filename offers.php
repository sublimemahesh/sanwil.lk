...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Ceylon Fine Spice | Offer</title>
    <!-- MOBILE SPECIFIC -->
                                    ...
                                    <div class="blog-post blog-grid blog-rounded blog-effect1">
                                        ...
                                        <div class="dlab-info">
                                            ...
                                            <div class="dlab-post-title">
                                                <h4 class="post-title"><?php echo $offer['title']; ?></h4>
                                            </div>

                                            <div class="dlab-post-text">
                                                <p class="offer-p"><?php echo substr($offer['short_description'], 0, 120), '...'; ?></p>
                                            </div>
                                            <div class="dlab-post-readmore">
                                                <div class="btn btn-sm btn1 btnhover"><i class="fa fa-angle-right"></i>READ MORE</div>
                                            </div>
                                        </div>
                                    </div>
                                </a>
