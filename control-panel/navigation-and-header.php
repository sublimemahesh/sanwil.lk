        ...
        <div class="menu">
            <ul class="list">
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="report-of-pending-order-products.php">
                                <i class="material-icons">shopping_cart</i>
                                <span>Pending Order Products</span>
                            </a>
                        </li>
                        <li>
                            <a href="report-of-confirmed-order-products.php">
                                <i class="material-icons">shopping_cart</i>
                                <span>Confirmed Order Products</span>
                            </a>
                        </li>
                    </ul>
                </li> 
