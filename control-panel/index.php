...
<head>
    ...
    <title>Dashbord | Ceylon Fine Spice</title>
    <!-- Favicon-->
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box bg-pink hover-expand-effect">
                            ...
                            <div class="content">
                                ...
                                <div class="number count-to" data-from="0" data-to="<?php echo $pending_orders; ?>" data-speed="1000" data-fresh-interval="20"></div>
                            </div>
                        </div>
                    </div>
                </a>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box bg-cyan hover-expand-effect">
                            ...
                            <div class="content">
                                ...
                                <div class="number count-to" data-from="0" data-to="<?php echo $confirmed_orders; ?>" data-speed="1000" data-fresh-interval="20"></div>
                            </div>
                        </div>
                    </div>
                </a>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box bg-light-green hover-expand-effect">
                            ...
                            <div class="content">
                                ...
                                <div class="number count-to" data-from="0" data-to=" <?php echo $success_orders; ?>" data-speed="1500" data-fresh-interval="1"></div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box bg-orange hover-expand-effect">
                            ...
                            <div class="content">
                                ...
                                <div class="number count-to" data-from="0" data-to="<?php echo $cancel_orders_count; ?>" data-speed="1000" data-fresh-interval="20"></div>
                            </div>
                        </div>
                    </div>
                </a>
